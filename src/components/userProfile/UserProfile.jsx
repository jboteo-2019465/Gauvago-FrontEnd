    ...
    <div className='container'>
      ...
      <div className="container-profile">
        <div className="card">
          ...
          {!loading && Array.isArray(user) && user.map((userData, id) => (
            <div key={userData.id}>
              <div className="card__title">{userData.username}</div>
              <div className="card__subtitle">{userData.email}</div>
            </div>
          ))}
        ...
        <form className="form" onSubmit={handleSubmit}>
          ...
          <label for="file" class="custum-file-upload">
            ...
            <input className="input" id="file" type="file" accept="image/*" name="image" onChange={handleImageChange} />
          </label>
